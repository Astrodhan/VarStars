...
# Import data 
astroinfo = pd.read_excel('17stars.xlsx')
...
for i in range(1,18):
    tr = html.new_tag('tr', style= 'border: 2px solid black')
    table.append(tr)
    ...
    td2 = html.new_tag('td', style= 'border: 1px solid black')
    tr.append(td2)
    ...
    data_table = html.new_tag('table', style='border-collapse: separate; border-spacing: 10px')
    sub_td1.append(data_table)
    ...
    comments_tr = html.new_tag('tr') #The third column will contain my comments
    data_table.append(data_tr1)
    data_table.append(data_tr2)
    data_table.append(comments_tr)
    ...
    coord_td.string = "J200 Coordinates: "+coordinate[i-1]
    ...
    sub_sub_td1 = html.new_tag('td', style= 'border: 1px solid black')
    ...
    sub_sub_td2 = html.new_tag('td', style= 'border: 1px solid black')
